...
#     BASE = "https://hcmadras.tn.gov.in/case_status_mas.php"
...
#             soup.find(id='cnr_captcha_img')['src']
#             captcha_url = "https://hcmadras.tn.gov.in"+soup.find(id='cnr_captcha_img')['src']
#             time.sleep(0.5)
#             img = self.session.get(captcha_url, headers=self.headers).content
...
#             soup=BeautifulSoup(r.text,'html.parser')
#             all_tr = soup.find(id='example11').find_all('tr')
