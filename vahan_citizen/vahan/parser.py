...
class Extractor:
    ...
    def extract_form_29_button(self, soup12):
        ...
        form_29_btn_id = soup12.find_all(
            class_='ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only display-none'
        )[2]['id']
        return form_29_btn_id, view_state
