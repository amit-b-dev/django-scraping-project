...
def vahan_timeline(request):
    try:
        ...
        chasis_no = request.data.get("chasis_no")
        ...
        for attempt in range(max_retries):
            ...
            # Open the target URL
            response = scraper.timeline_data(vehicle_no,chasis_no)
...
def vahan_timeline_via_s_no(request):
    try:
        ...
        for attempt in range(max_retries):
            ...
            # Initialize scraper and use global driver
            scraper = VahanScraper()
            response = scraper.form29_via_s_no(vehicle_no,s_no,chasis_no)
...
def vahan_transactions_list(request):
    try:
        ...
        for attempt in range(max_retries):
            ...
            # use global driver
            scraper = VahanScraper()
            response = scraper.transaction_data(vehicle_no,chasis_no)
...
def form29(request):
    try:
        ...
        for attempt in range(max_retries):
            ...
            # Initialize scraper and use global driver
            scraper = VahanScraper()
            response = scraper.fetch_Newest_Form29_Data(vehicle_no,chasis_no)
